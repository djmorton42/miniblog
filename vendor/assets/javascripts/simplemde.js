...
function drawSpecificImage(editor, imageUrl) {
	var cm = editor.codemirror;
	var stat = getState(cm);
	var options = editor.options;
	var url = imageUrl;
...
SimpleMDE.drawSpecificImage = drawSpecificImage;
...
SimpleMDE.prototype.drawSpecificImage = function(value) {
    drawSpecificImage(this, value)
};
