class Admin::CommentsController < Admin::AdminAreaController

  def approve
    comment = Comment.find(params[:id])
    comment.update_attributes(is_approved: true, approved_at: Time.now)
  ...
  def unapprove
    comment = Comment.find(params[:id])
    comment.update_attributes(is_approved: false, approved_at: nil)
  ...
  def delete
    comment = Comment.find(params[:id])
    comment.update_attributes(is_deleted: true, deleted_at: Time.now)
